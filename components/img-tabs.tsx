          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-6xl">
              ...
              <div className="relative mx-auto max-w-5xl overflow-hidden rounded-lg border border-gray-200 shadow-xl">
                {activeTab === "organize" && (
                  <Image src="/hero images/hero1.png" alt="Organize Applications" width={1200} height={800} className="" />
                )}
                {activeTab === "hired" && (
                  <Image src="/hero images/hero2.png" alt="Get Hired" width={1200} height={800} className="" />
                )}
                {activeTab === "boards" && (
                  <Image src="/hero images/hero3.png" alt="Manage Boards" width={1200} height={800} className="" />
                )}
              </div>
            </div>
          </div>
